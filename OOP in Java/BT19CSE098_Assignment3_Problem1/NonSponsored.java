public class NonSponsored extends Student{   //NonSponsored class derived from Student class
    private double total_fee;   //private data member
    public NonSponsored(String name,String address,String phonenum,String emailid,double basic_fee,double other_fee,int status){    //parameterized construtor
	...
	total_fee=0.7*get_fee(1) + get_status()*get_fee(2);               //total fee calculation
	return total_fee;
    }
